...
public class PicturePictures
{
     ...
     */
    public PicturePictures(String source)
    {
        load(source);
    }
     ...
     */
    public PicturePictures(double width, double height)
    {
    ...
    public PicturePictures(int[][] grayLevels)
    {
     ...
     */
    public ColorPictures getColorAt(int i)
    {
     ...
     */
    public void setColorAt(int i, ColorPictures color)
    {
        if (image == null || i < 0 || i >= pixels())
        {
            throw new IndexOutOfBoundsException("" + i);
     ...
     * @param color the new color for the pixel
     */
    public ColorPictures getColorAt(int x, int y)
    {
        ...
        else
        {
            ...
            return new ColorPictures(rgb / 65536, (rgb / 256) % 256, rgb % 256);
        }
    }
     ...
     */
    public void setColorAt(int x, int y, ColorPictures color)
    {
        if (image == null || x < 0 || x >= image.getWidth() || y < 0 || y >= image.getHeight())
        {
            throw new IndexOutOfBoundsException("(" + x + "," + y + ")");
    ...
    static class Canvas
    {
        ...
        private ArrayList<PicturePictures> pictures = new ArrayList<PicturePictures>();
        ...
        class CanvasComponent extends JComponent
        {
            public void paintComponent(Graphics g)
            {
                ...
                for (PicturePictures s : pictures)
                {
        ...
        public void show(PicturePictures s)
        {
